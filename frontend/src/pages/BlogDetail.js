        ...
        <div className="max-w-6xl mx-auto p-4 bg-card text-card-foreground rounded-lg shadow-md">
          ...
          <div className="p-4">
            ...
            <p className="text-muted-foreground mb-4">
              ...
              with right design and decor pieces, they can be transformed into a
              beautiful and functional outdoor haven. Modern balcony decor ideas
              are perfect to transform a small balcony into an inviting and
              stylish space.
            </p>
            <p className="text-muted-foreground">
              ...
              furniture works perfectly for balconies that are small. Same way,
              you can introduce a mini garden to your balcony if it receives an
              ample amount of natural to enhance the overall aesthetic appeal of
              your balcony. Built-in seating areas, aesthetic furniture, and
              recessed lighting are some of the cool ways to create a
              personalised balcony space.
            </p>
          </div>
          <div>
