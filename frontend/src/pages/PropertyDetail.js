          ...
          <div className="max-w-6xl  p-4">
            ...
            <div className="bg-white text-card-foreground p-6 rounded-lg shadow-lg">
              ...
              <p className="text-muted-foreground mb-4">
                Signature Global Titanium SPR in Sector 71, Gurgaon, offers a
                prime opportunity for homebuyers. Developed by Signatureglobal
                India Limited, this project features apartments currently
                available for sale. It's under construction and is expected to
                be completed by Feb, 2029. As a RERA-registered housing society,
                Signature Global Titanium SPR provides full project details on
                the state RERA website, ensuring transparency and reliability
                for buyers. The RERA registration number is
                RC/REP/HARERA/GGM/831/563/2024/58, dated June 3, 2024.
              </p>
            ...
            <div className="bg-white text-card-foreground p-4 rounded-lg shadow-md  mx-auto my-8">
              ...
              <div className="flex flex-col md:flex-row">
                <ul className="flex-1 space-y-2 pr-4 ">
                  ...
                  <li>
                    {" "}
                    Multi-use court for volleyball, badminton, basketball, and
                    practice cricket pitch, plus 55+ sports activities
                  </li>
            ...
            <div className="p-6 bg-card rounded-lg shadow-md bg-white">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <img
                  src="https://placehold.co/300x200"
                  alt="Balcony view of high-rise buildings"
                  className="rounded-lg"
                />
                <img
                  src="https://placehold.co/300x200"
                ...
                <img
                  src="https://placehold.co/300x200"
                  alt="High-rise buildings with swimming pool"
                  className="rounded-lg"
                />
                <img
                  src="https://placehold.co/300x200"
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                ...
                <img
                  src="https://placehold.co/800x600"
                  alt="Floor plan image 2"
                  className="rounded-lg shadow-md"
                />
                <img
                  src="https://placehold.co/800x600"
                  alt="Floor plan image 3"
                  className="rounded-lg shadow-md"
                />
              </div>
            </div>
              ...
              {faqs.map((faq, index) => (
                <div key={index} className="mb-2 border-b">
                  ...
                  <Transition
                    ...
                    leaveTo="opacity-0"
                  >
                    <div className="px-4 pb-2 text-gray-600">{faq.answer}</div>
                  </Transition>
                </div>
              ))}
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md mt-[20px]">
              ...
              <div className="flex flex-col md:flex-row items-start">
                ...
                <div className="text-muted-foreground">
                  <p className="mb-4">
                    Signature Global is the Largest real estate development
                    company in Delhi-NCR, focused on affordable and mid segment
                    housing (LIG and MIG) in terms of unit supplied (in the
                    below Rs.80 lakh price category) between 2019 and 2021 with
                    a market share of 19%.
                  </p>
                  <p className="mb-4">
                    The company commenced its operations in 2014 through its
                    subsidiary, Signature Builders Private Limited, with the
                    launch of our Solera project on 6.13 acres of land in
                    Gurugram, Haryana. We have grown our operations over the
                    years and in less than a decade, and as of March 31, 2022,
                    we had sold 23,453 residential and commercial units, all
                    within the Delhi NCR region, with an aggregate Saleable Area
                    of 14.59 million square feet.
                  </p>
                  <p>
                    Strategically focused on Government of India and state
                    government policies supporting affordable housing,
                    specifically the Affordable Housing Policy, 2013 notified by
                    the Town and Country Planning Department, Government of
                    Haryana (“AHP”) and the Affordable Plotted Housing Policy or
                    the Deen Dayal Jan Awas Yojana (“DDJAY - APHP”). Most of our
                    Completed Projects, Ongoing Projects and Forthcoming
                    Projects are located in Gurugram and Sohna in Haryana.
                  </p>
                </div>
              </div>
            </div>
