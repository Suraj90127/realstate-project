              ...
              <div className="lg:col-span-7 sm:col-span-12">
                <div className="element-container">
                  ...
                  <p className="  mt-6 text-justify text-[17px] font-[400] roboto-regular text-gray-600">
                    ...
                    honest information and services to make the property buying
                    process easier for buyers. We help property buyers end to
                    end, starting from property search till purchase.
                    Understanding the client’s needs and accordingly help buyers
                    with the ideal investment opportunity. We are driven by the
                    fundamental values of customer satisfaction, credibility and
                    professionalism. We help buyers and sellers to buy, rent and
                    sell properties in India with major focus on Gurgaon, Delhi
                    and Bangalore.
                  </p>
                  <p className="text-justify mt-5 text-[17px] font-[400] roboto-regular text-gray-600">
                    ...
                    treating our customers with respect and fairness. Propzilla
                    Infratech’s motto is to “Bridging Dreams To Reality” -
                    offering informative and accurate services in the real
                    estate industry. With unparalleled services the company
                    continuously achieving new milestones and works to be the
                    first priority for investors.
                  </p>
                </div>
              </div>
              {/* <!-- ... --> */}
              ...
              <div className="grid grid-cols-12 gap-6">
                <div className="md:col-span-6 sm:col-span-12">
                  <div className="missen-div">
                    ...
                    <p className="mt-5 text-[17px] font-[500]">
                      Our mission is to maximize client satisfaction by offering
                      them priority service. We consistently strive to deliver
                      quality service and are always willing to go extra mile
                      for customers. With the purpose to become India’s most
                      appreciated real estate company, we work with dedication
                      and honesty
                    </p>
                  </div>
                </div>
                <div className="md:col-span-6 sm:col-span-12">
                  <div className="missen-div">
                    ...
                    <p className="mt-5 text-[17px] font-[500]">
                      Our vision is to become a preferred choice for people who
                      want to buy or sell property. We believe in making
              ...
              <div className="slider-container">
                <Slider {...settings}>
                  <div className="slick-slide">
                    ...
                    <div className="bg-black text-white">
                      <p className="py-3 px-20">
                        Lorem ipsum dolor sit, amet consectetur adipisicing hsyd
                        hss
                      </p>
                    </div>
                  </div>
                  <div className="slick-slide">
                    ...
                    <div className="bg-black text-white">
                      <p className="py-3 px-20">
                        Lorem ipsum dolor sit, amet consectetur adipisicing hsjs
                        nsub
                      </p>
                    </div>
                  </div>
