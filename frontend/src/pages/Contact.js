    ...
    <div className='contact'>
      ...
      <div className="container sm:px-0  md:px-5 py-24 mx-auto flex sm:flex-wrap sm:flex-col-reverse md:flex-row md:flex-nowrap flex-wrap">
        <div className="lg:w-2/3 md:w-1/2 sm:w-[100%] sm:mt-5 md:mt-0 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
          ...
          <div className="bg-white relative flex flex-wrap py-6 rounded shadow-md">
            ...
            <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
              ...
              <a className="text-[#fead26] leading-relaxed">example@email.com</a>
        ...
        <div className="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
          <h2 className="text-gray-900 text-center text-2xl mb-1 font-bold title-font">GET IN TOUCH WITH US!</h2>
          ...
          <div className="relative mb-4">
            <label htmlFor="number" className="leading-7 text-sm text-gray-600">Mobile No.</label>
            <input
              type="number"
              id="number"
              name="number"
          ...
          <button className="text-white bg-[#fead26] border-0 py-2 px-6 focus:outline-none hover:[#fead26] rounded text-lg">Request a Call Back</button>
