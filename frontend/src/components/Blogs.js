...
const Blogs = () => {
  const dataArray = [
    { id: 1, date: '13 May, 2023', title: '15 Modern Balcony Decoration Ideas for Your Home in India', content: 'Discover the latest trends in balcony decoration and get inspired to transform your space.', image: 'https://placehold.co/600x400' },
    { id: 2, date: '14 Sep, 2022', title: 'Real Estate Trends Post Covid', content: 'Explore the changing landscape of real estate post-Covid and its impact on the market.', image: 'https://placehold.co/600x400' },
    { id: 3, date: '14 Sep, 2022', title: 'Best Places To Live In Gurgaon With Family', content: 'Discover the top family-friendly neighborhoods in Gurgaon for a comfortable living experience.', image: 'https://placehold.co/600x400' },
  ];
          ...
          {dataArray.map((data) => (
            ...
            >
              ...
              <div className="p-4">
                ...
                <span className="text-primary hover:underline text-[#fead26]">READ FULL STORY</span>
              </div>
            </Link>
          ))}
        </div>
